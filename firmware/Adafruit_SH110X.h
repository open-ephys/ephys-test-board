...
public:
  ...
  Adafruit_SH110X(uint16_t w, uint16_t h, int16_t mosi_pin, int16_t sclk_pin,
                  int16_t dc_pin, int16_t rst_pin, int16_t cs_pin, spi_inst_t *spi , uint baud_rate);
...
public:
  ...
  Adafruit_SH1106G(uint16_t w, uint16_t h, int16_t mosi_pin, int16_t sclk_pin,
                   int16_t dc_pin, int16_t rst_pin, int16_t cs_pin, spi_inst_t *spi , uint baud_rate = 8000000UL);
